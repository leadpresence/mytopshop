...
class ProductsRepository {
 ...
 Product(
      category: PCategory.accessories,
      id: 0,
      isFeatured: true,
      name: 'Vagabond sack',
      price: 120,
  ...
  static List<Product> loadProducts(PCategory category) {
    if (category == PCategory.all) {
      return _allProducts;
    } else {
